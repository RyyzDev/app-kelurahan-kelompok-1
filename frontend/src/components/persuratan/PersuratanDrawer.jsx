...
import { X, FilePlus, ClipboardList, ArrowRight } from 'lucide-react';

const PersuratanDrawer = ({ isOpen, onClose }) => {
  const navigate = useNavigate();

  const menuItems = [
    {
      title: 'Buat Surat Baru',
      description: 'Ajukan permohonan e-Surat atau Cap Basah.',
      icon: FilePlus,
      color: 'bg-red-50',
    ...
    {
      title: 'Status Surat Saya',
      description: 'Pantau progres pengerjaan & download surat.',
      icon: ClipboardList,
      color: 'bg-blue-50',
          ...
          >
            ...
            <div className="flex justify-between items-center mb-8">
              <div>
                ...
                <p className="text-sm font-bold text-gray-400 mt-1">Layanan Persuratan Digital</p>
              </div>
...
export default PersuratanDrawer;
